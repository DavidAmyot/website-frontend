// GSAP script for doing animations on the animated background
// from the index page. Queries the ids from the animated-background
// svg component to trigger the desired animations along with the 
// scrollElement className from the index page for positionning.
...
ScrollTrigger.create({
    animation: scene1,
    trigger: "[class^='index_scrollElement']",
    start: "top top",
    end: "45% 100%",
    scrub: 3,
});
